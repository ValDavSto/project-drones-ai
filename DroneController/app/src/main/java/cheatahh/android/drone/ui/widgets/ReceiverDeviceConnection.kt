...
@Composable
fun ReceiverDeviceConnection(connectionState: MutableIntState, loadingState: MutableIntState, messageState: MutableState<String>, onAction: (Action) -> Unit) {
        ...
        Box(
            ...
            Column {
                ...
                if (connection == 1) Column(
                    ...
                    for (action in Action.entries) ReceiverDeviceConnectionAction(
                        isLoading != 0,
                        action,
                        onAction
                    )
...
fun ReceiverDeviceConnectionPreview() {
    ...
    val message = mutableStateOf("Hello World")
    ReceiverDeviceConnection(connected, isLoading, message) {}
}